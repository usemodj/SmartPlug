...
module.exports = function(config) {
  config.set({
    ...
    files: [
      ...
      'client/bower_components/pickadate/lib/shadow.js',
      'client/bower_components/pickadate/lib/ui-picker.js',
      'client/bower_components/pickadate/lib/ui-pickadate.js',
